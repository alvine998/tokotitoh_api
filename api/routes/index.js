...
module.exports = (app) => {
  ...
  const cOtp = require("../controllers/otp.js");
  ...
  app.post(
    "/sendmail/verification/registration",
    middlewareHere,
    cMailer.sendEmailVerificationRegister,
  );
  ...
  app.post(
    ...
    middlewareHere,
    middlewarePackageName,
    cUser.verificationResetPassword,
  );
  app.post(
    "/user/verification/registration",
    middlewareHere,
    middlewarePackageName,
    cUser.verificationRegistration,
  );
  app.post(
